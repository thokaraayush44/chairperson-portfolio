...
export function ContactCta() {
  return (
    <section className="mt-16 bg-background px-72 py-64 text-white sm:px-10 sm:py-20">
      <div className="mx-auto flex max-w-[1400px] items-center justify-center rounded-[1rem] bg-primary-100 px-12 py-10 shadow-xl shadow-slate-900/20 sm:flex-col sm:px-6 sm:py-8">
        <div className="flex-1 text-center sm:text-center">
          <h2 className="text-4xl font-serif font-semibold text-white sm:text-3xl">
            Have a Concern or Suggestion for Ward Development?
          </h2>
          <p className="mt-4 text-base leading-7 text-slate-200">
            Reach out to our office directly — every voice from Kalikot matters to us.
          </p>
        </div>
